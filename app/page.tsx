...
function MyButton({ title, className }: { title: string; className?: string }) {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="flex items-center justify-center w-full max-w-4xl">
        ...
        <div className="flex flex-col items-center mx-8 space-y-4">
          <MyButton
            title="← Rejoindre l'équipe bleu"
            className="px-4 py-2 w-[227px] bg-gray-200 text-black rounded shadow"
          />
